...
/**
 * Save component for Google Maps block
    ...
    return (
        <div {...blockProps}>
            <div id={`ep-gutenberg-content-${_md5ClientId}`} className="ep-gutenberg-content">
                <div className={'embedpress-document-embed ep-google-maps-' + id + ' ' + content_share_class + ' ' + share_position_class + ' ' + width_class} id={`ep-google-maps-${clientId}`} data-source-id={'source-' + clientId} data-embed-type="Google Maps">
